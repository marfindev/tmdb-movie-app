package com.marfin.movietmdbapp.notification;
...
import com.marfin.movietmdbapp.MainActivity;
...
public class NotificationDailyReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        sendNotification(context, context.getString(R.string.app_name), "Surpise Today!");
    }
    ...
    private void sendNotification(Context context, String title, String desc) {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(context)
                .setSmallIcon(R.drawable.ic_film_reel24)
